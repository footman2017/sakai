 ...
 */
public class StudentRankSummaryPanel extends BasePanel {
	...
	public StudentRankSummaryPanel(final String id, final IModel<Map<String, Object>> model) {
		super(id, model);
	}
	...
	public void onBeforeRender() {
		...
		final WebMarkupContainer noAssignments = new WebMarkupContainer("noAssignments") {
			...
			public boolean isVisible() {
				return !StudentRankSummaryPanel.this.someAssignmentsReleased;
			}
		};
