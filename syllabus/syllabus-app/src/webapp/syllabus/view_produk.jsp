	...
	<span id="warningInfo" class="alertMessage popupMessage" style="display:none; float: left;"></span>
		...
		<h:form id="syllabusViewData">
	      ...
	      <syllabus:syllabus_if test="#{SyllabusTool.syllabusItem.redirectURL}">
		     ...
		     <h:dataTable id="dataTable" value="#{SyllabusTool.entries1}" var="eachEntry" summary="#{msgs.mainEditListSummary}" styleClass="listHier lines nolines"
						...
						<h:column rendered="#{! SyllabusTool.displayNoEntryMsg}">
							...
							<h:outputText value="#{eachEntry.entryFD.kodeProduk}"/>
						...
						<h:column rendered="#{! SyllabusTool.displayNoEntryMsg}">
							...
							<h:outputText value="#{eachEntry.entryFD.namaProduk}"/>
							<f:verbatim><br/></f:verbatim>
						</h:column>
						...
						<h:column rendered="#{! SyllabusTool.displayNoEntryMsg}">
							...
							<h:outputText value="#{eachEntry.entryFD.hargaProduk}"/>
							<f:verbatim><br/></f:verbatim>
						</h:column>
						...
						<h:column rendered="#{! SyllabusTool.displayNoEntryMsg}">
							...
							<h:outputText value="#{eachEntry.entryFD.kodeJenisProduk}"/>
							<f:verbatim><br/></f:verbatim>
						</h:column>
			 ...
			 <f:verbatim><p class="act"></f:verbatim>	
				<h:commandButton 
				     value="#{msgs.back}" 
					 action="#{SyllabusTool.processBackToMain}"
					 title="#{msgs.update}"
				     rendered="#{! SyllabusTool.displayNoEntryMsg}"
					 accesskey="s" styleClass="active" />
				<h:commandButton 
				     value="#{msgs.inputProdukBtn}" 
					 action="#{SyllabusTool.processNewInputProduk}"
					 title="#{msgs.reset}"
				     rendered="#{! SyllabusTool.displayNoEntryMsg}"
					 accesskey="s" styleClass="active"/>
				<h:commandButton
